...
- `/tv` - live display for the big screen
- `/admin` - event setup, active event switching, corrections, QR code, and CSV export
...
4. Show the QR code to race officials.
5. Open `/tv` on the display screen.
